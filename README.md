...
```
yarn add @ravindu01manoj/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:Ravindu-Manoj/Baileys-
```

Then import your code using:
``` ts 
import makeWASocket from '@ravindu01manoj/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@ravindu01manoj/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@ravindu01manoj/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@ravindu01manoj/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@ravindu01manoj/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@ravindu01manoj/baileys'
                                */
...
import { downloadMediaMessage } from '@ravindu01manoj/baileys'
